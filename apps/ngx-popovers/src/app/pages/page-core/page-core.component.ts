...
import { ClickOutsideIcon, CoreIcon, FloatingIcon, PortalIcon } from '../../routes-icons';
...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, TitleComponent, CoreIcon, RouterLink, HighlightComponent, PortalIcon, FloatingIcon, ClickOutsideIcon],
